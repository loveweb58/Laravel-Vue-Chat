...
;(function ($, window, undefined) {
    ...
    $(document).ready(function () {
                        ...
                        success: function (response) {
                            ...
                            setTimeout(function () {
                                ...
                                if (login_status == 'invalid') {
                                    ...
                                    neonLogin.resetProgressBar(true, response.description);
                                }
                                else if (login_status == 'success') {
                                    // Redirect to login page
                                    setTimeout(function () {
                                        var redirect_url = Config.defaultURL;
        ...
        if (is_lockscreen) {
            ...
            neonLogin.$container.validate({
                ...
                submitHandler: function (ev) {
                    ...
                    $.ajax({
                        url: Config.defaultURL + '/ga/verify',
                        method: 'POST',
                        dataType: 'json',
                        data: {
                            password: $("input#password").val(),
        ...
        $.extend(neonLogin, {
            ...
            resetProgressBar: function (display_errors, description) {
                ...
                setTimeout(function () {
                    ...
                    if (display_errors) {
                        ...
                        $errors_container.find('h3').html(description);
