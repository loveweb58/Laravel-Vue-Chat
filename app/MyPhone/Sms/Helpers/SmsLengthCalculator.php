...
namespace App\MyPhone\Sms\Helpers;
...
class SmsLengthCalculator
{
    ...
    private $gsm_chars_replace = [];

    private $gsm_chars_ext_esc = [];

    private $gsm_chars_all = [];
    ...
    /**
     * @param string $content - Message content, encoded in UTF-8
     *
     * @return int - Number of parts this message is split up to when sent via SMS
     */
     ...
     * @param string $content - Message content, encoded in UTF-8
     *
     * @return int - Returns GSM_CHARSET_GSM7 if all characters are present in GSM charset or GSM_CHARSET_UNICODE if
     *             message must be sent in Unicode (UCS-2) charset instead
     */
